...
var rootRef = firebase.database().ref().child("Problem");
        ...
        var imgurl;
        rootRef.orderByChild('Rating').on("child_added", snap => {
...
// firebase.auth().signInAnonymously().then(function() {
  ...
  // console.log('Before requesting download URL');
    ...
    $("#table_body").append("<tr><td><img src=" + imgurl + "/img></td><td>" + email + "</td><td>" + city + "</td><td>" + addr + "</td><td>" + desc + "</td><td>" + rating + "</td></tr>");
});
